...
Original file is located at
    https://colab.research.google.com/drive/1vefV1GPCM1XYKLRfjw6NqfvYxg_KytLQ
"""
...
import os
os.chdir('/content/gdrive/MyDrive/209/project/')
...
base_url = "https://github.com/phlippe/saved_models/tree/main/tutorial10/"
# Files to download
...
for dir_name, file_name in pretrained_files:
    ...
    if not os.path.isfile(file_path):
        ...
        if file_name.endswith(".zip"):
            ...
            with gzip.GzipFile(file_path, 'r') as zip_ref:
                zip_ref.open(file_path.rsplit("/",1)[0])
...
imagenet_path = os.path.join(DATASET_PATH, "ImageNet/TinyImageNet")
